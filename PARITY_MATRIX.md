...
| reco-calibrate | AKAZE/optimizer/audio/lens DB | `cpp/reco_calibrate` | In progress for config/data types, deterministic geometry/reprojection helpers, descriptor matching, spatial overlap filtering, frame sampling/downscale helpers, RANSAC fundamental-matrix inlier selection, and default matcher/filter/cost policies | Deferred: AKAZE detector, optimizer driver, audio/video sampling, telemetry, lens DB resource packaging; add fixtures, resource packaging, tolerance tests |
