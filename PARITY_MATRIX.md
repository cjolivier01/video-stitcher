...
| reco-detect | ORT/TensorRT/NCNN/CoreML/CUDA/NPP | `cpp/reco_detect` | In progress for shared YOLO postprocess, ball-detector adapter/NMS, labels file parsing, and AI probe result data helpers | Deferred: ORT/TensorRT/NCNN/CoreML/CUDA/NPP inference and GPU preprocessing backends; add backend probes, GPU preprocess tests, `onnx_names` fuzz |
