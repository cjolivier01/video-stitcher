...
| reco-autocam | panners/trackers/ROI | `cpp/reco_autocam` | In progress for `TrackingMode`, ROI anchor filtering policy, tracker coaster lifecycle, and deterministic sweep panner | Deferred: field panner, file panner, ball tracker, class provider, WGPU detector wiring; add panner/trajectory fixture tests |
