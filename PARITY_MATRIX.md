...
| reco-calibrate | AKAZE/optimizer/audio/lens DB | `cpp/reco_calibrate` | In progress for config/data types, deterministic geometry/reprojection helpers, descriptor matching, spatial overlap filtering, and frame sampling/downscale helpers | Deferred: AKAZE detector, RANSAC binding, optimizer driver, audio/video sampling, telemetry, lens DB resource packaging; add fixtures, resource packaging, tolerance tests |
