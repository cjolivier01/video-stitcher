...
| reco-calibrate | AKAZE/optimizer/audio/lens DB | `cpp/reco_calibrate` | In progress for config/data types and deterministic geometry/reprojection helpers | Deferred: AKAZE, optimizer driver, audio/video sampling, telemetry, lens DB resource packaging; add fixtures, resource packaging, tolerance tests |
