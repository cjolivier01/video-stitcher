...
void matched_point_and_params_match_rust() {
  ...
  const auto params = OptParams{.x_ty = 0.01,
                                .intersect = 0.55,
                                .cam_d = 0.24,
                                .x_rz = 0.008,
                                .z_rx = -0.004,
...
void reprojection_costs_match_rust_properties() {
  ...
  const OptParams perfect_params{.x_ty = 0.0,
                                 .intersect = 1.0,
                                 .cam_d = 0.25,
                                 .x_rz = 0.0,
                                 .z_rx = 0.0};
...
void seam_weighting_matches_rust_properties() {
  ...
  const MatchedPoint near_seam{.left = {0.1, 0.0},
                               .right = {0.1, 0.0},
                               .left_pixel_nx = 0.25,
                               .right_pixel_nx = 0.75};
  const MatchedPoint far_from_seam{.left = {0.1, 0.0},
                                   .right = {0.1, 0.0},
                                   .left_pixel_nx = 0.8,
                                   .right_pixel_nx = 0.2};
  ...
  const double nan_sigma =
      seam_weighted_reprojection_error({near_seam}, params, std::numeric_limits<double>::quiet_NaN());
